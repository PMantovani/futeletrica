import { findAllAthletes, getAllAthletes, getAthleteSeasonSummary, getAthleteStandings } from "@/server/services/athlete";
...
export const athleteRouter = router({
  ...
  getAllAthletes: procedure.query(() => getAllAthletes(4)),
